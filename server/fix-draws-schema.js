...
async function fixDrawsSchema() {
  ...
  console.log('Attempting to fix draws schema (winning_numbers, jackpot_rollover)...');
  ...
  try {
    ...
    console.log('Successfully fixed draws schema columns (or they already existed).');
  } catch (err) {
