...
export default function Login() {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col ${isDark ? "bg-dark-bg" : "bg-light-bg"}`}
    >
      <Navbar />

      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 pt-24">
        <div
          className={`w-full max-w-md p-8 sm:p-10 rounded-3xl glass-card shadow-2xl`}
        >
          ...
          <div className="relative my-8">
            <div className={`absolute inset-0 flex items-center`}>
              <div
                className={`w-full border-t ${isDark ? "border-dark-border" : "border-light-border"}`}
              ></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span
                className={`px-4 ${isDark ? "bg-dark-card text-gray-500" : "bg-white text-light-subtext"}`}
              >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label
                  className={`block text-sm font-medium ${isDark ? "text-gray-300" : "text-light-text"}`}
                >
                  Password
                </label>
                <Link
          ...
          <p
            className={`mt-8 text-center text-sm ${isDark ? "text-gray-400" : "text-light-subtext"}`}
          >
            ...
            >
              Sign up today{" "}
              <ArrowRight size={14} className="inline ml-0.5 -mt-0.5" />
            </Link>
          </p>
        </div>
      </main>
