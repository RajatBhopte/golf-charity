...
const prizeTiers = [
  {
    ...
    title: "Jackpot",
    pool: "40%",
    amount: formatCurrencyINR(300000),
    featured: true,
  },
  {
    match: "4",
    title: "Grand Prize",
    pool: "35%",
    amount: formatCurrencyINR(262500),
    featured: false,
  },
  {
    match: "3",
    title: "Winner",
    pool: "25%",
    amount: formatCurrencyINR(187500),
    featured: false,
  },
];
...
export default function Home() {
  ...
  return (
    ...
    >
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              subscription supports a charity you choose.
            </motion.p>
      ...
      <section
        id="how-it-works"
        className={`section-padding border-t ${isDark ? "border-dark-border" : "border-light-border"}`}
      >
        <div className="container-max">
          ...
          >
            <motion.span
              variants={fadeInUp}
              className={`inline-block px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase mb-4 ${isDark ? "bg-brand-500/10 text-brand-400" : "bg-brand-50 text-brand-700"}`}
            >
              Simple and Transparent
            </motion.span>
            <motion.h2
              variants={fadeInUp}
              className={`text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 ${isDark ? "text-white" : "text-light-text"}`}
            >
          ...
          >
            {[
              ...
              >
                <div
                  className={`absolute top-6 right-6 text-5xl font-black ${isDark ? "text-dark-border" : "text-gray-100"} group-hover:text-brand-500/10 transition-colors`}
                >
                  {step}
                </div>
                <div
                  className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 ${isDark ? "bg-brand-500/10" : "bg-brand-50"}`}
                >
                  <Icon size={28} className="text-brand-500" />
                </div>
                <h3
                  className={`text-xl font-bold mb-3 ${isDark ? "text-white" : "text-light-text"}`}
                >
                  {title}
                </h3>
                <p
                ...
                <span
                  className={`inline-flex items-center gap-1 text-sm font-semibold ${isDark ? "text-brand-400" : "text-brand-600"}`}
                >
                  <Zap size={14} />
                  {highlight}
                </span>
                {index < 2 && (
                  <div className="hidden md:flex absolute -right-4 top-1/2 -translate-y-1/2 z-10">
                    <ChevronRight
                      size={24}
                      className={isDark ? "text-dark-border" : "text-gray-300"}
                    />
                  </div>
                )}
              </motion.div>
          ...
          >
            {prizeTiers.map((tier) => (
              ...
              >
                ...
                <div
                  className={`text-4xl font-black mb-2 ${tier.featured ? "text-yellow-500" : "gradient-text"}`}
                >
                  {tier.pool}
                </div>
                <h3
                  className={`text-2xl font-bold mb-1 ${isDark ? "text-white" : "text-light-text"}`}
                >
                  {tier.title}
                </h3>
                <p
                ...
                <div
                  className={`py-3 px-4 rounded-xl ${isDark ? "bg-dark-bg/50" : "bg-light-bg"}`}
                >
                  <span
                    className={`text-lg font-bold ${isDark ? "text-white" : "text-light-text"}`}
                  >
                    {tier.amount}
                  </span>
                  <span
        ...
        <div className="container-max">
          ...
          >
            {[
              {
                icon: Heart,
                value: formatCurrencyINR(totalRaised),
                label: "Total Donated",
              },
              {
                icon: Users,
              ...
              {
                icon: Gift,
                value: featuredCharity ? "Live" : "Soon",
              ...
              >
                ...
                <div
                  className={`text-2xl font-bold ${isDark ? "text-white" : "text-light-text"}`}
                >
                  {value}
                </div>
                <div
      ...
      >
        <div className="container-max">
          ...
          >
            <motion.h2
              variants={fadeInUp}
              className={`text-3xl sm:text-4xl font-bold mb-4 ${isDark ? "text-white" : "text-light-text"}`}
            >
          ...
          >
            <div className="space-y-6">
                ...
                >
                  {[12, 18, 25, 31, 40].map((number) => (
                    <motion.div
                      ...
                      variants={chipReveal}
                      whileHover={{ y: -2, scale: 1.03 }}
                      className="w-14 h-14 rounded-xl bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-brand-500/20"
                    >
                      {number}
                    </motion.div>
                  ))}
              ...
              <div
                className={`border-t border-dashed ${isDark ? "border-dark-border" : "border-light-border"}`}
              />
              ...
              <motion.div
                ...
                className={`flex items-center gap-3 p-4 rounded-xl ${isDark ? "bg-brand-500/10" : "bg-brand-50"}`}
              >
                <Trophy className="text-brand-500" size={24} />
                <div>
                  <p
                    className={`font-bold ${isDark ? "text-white" : "text-light-text"}`}
                  >
                    3-number match
                  </p>
                  <p
      ...
      <section className="section-padding relative overflow-hidden">
        <div
          className={`absolute inset-0 ${isDark ? "bg-gradient-to-b from-dark-bg via-brand-900/20 to-dark-bg" : "bg-gradient-to-b from-light-bg via-brand-50 to-light-bg"}`}
        />
        <div className="container-max relative z-10">
          ...
          >
            <motion.h2
              variants={fadeInUp}
              className={`text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 ${isDark ? "text-white" : "text-light-text"}`}
            >
              Ready to Make Your{" "}
